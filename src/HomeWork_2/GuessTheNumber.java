 ...
 * computer-guessed number entered by the user. The program asks the
 * user for an integer value from 0 to 100. Then the computer uses a
 * loop to select a number equal to the number entered by the user.
